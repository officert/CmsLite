...
ko.utils = new (function () {
    ...
    return {
        ...
        tagNameLower: function(element) {
            // For HTML elements, tagDisplayName will always be upper case; for XHTML elements, it'll be lower case.
        ...
        getFormFields: function(form, fieldName) {
            ...
            var isMatchingField = (typeof fieldName == 'string')
                ...
                : function(field) { return fieldName.test(field.name) }; // Treat fieldDisplayName as regex or object containing predicate
            var matches = [];
...
ko.utils.domNodeDisposal = new (function () {
    ...
    function cleanSingleNode(node) {
        ...
        // node.getElementsByTagDisplayName("*") in cleanNode() (comment nodes aren't elements)
...
var attrHtmlToJavascriptMap = { 'class': 'classDisplayName', 'for': 'htmlFor' };
    ...
    'update': function(element, valueAccessor, allBindingsAccessor) {
        ...
        for (var attrName in value) {
            if (typeof attrName == "string") {
                ...
                // Deliberately being case-sensitive here because XHTML would regard "DisplayName" as a different thing
...
(function () {
    ...
    ko.expressionRewriting.bindingRewriteValidators['template'] = function(bindingValue) {
        ...
        if (ko.expressionRewriting.keyValueArrayContainsKey(parsedBindingValue, "name"))
            return null; // DisplayNamed templates can be rewritten, so return "no error"
